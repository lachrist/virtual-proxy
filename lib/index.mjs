 ...
 *   $target: V,
 *   target: T,
 *   handler: import(".").ActualHandler<T>,
 * ) => boolean}
 */
 ...
 * @template {object} T
 * @template {object} V
 * @type {import(".").VirtualHandler<T, V>}
 */
const virtual_handler_prototype = {
  //////////////
  // Function //
  //////////////
 ...
 * ) => import(".").ActualHandler<T>}
 */
const toActualHandler = (handler) => {
  const descriptor = {
    __proto__: null,
    value: /** @type {any} */ (null),
    writable: true,
...
/**
 * @type {import("../type").virtualizeHandler}
 */
export const virtualizeHandler = (target, handler) =>
  /** @type {any} */ ({
    __proto__: virtual_handler_prototype,
    target,
    handler: toActualHandler(handler),
  });

/** @type {import("../type").VirtualProxy} */
export const VirtualProxy = function (virtual, target, handler) {
  return new Proxy(virtual, virtualizeHandler(target, handler));
};

/** @type {import("../type").RevocableVirtualProxy} */
export const RevocableVirtualProxy = function (virtual, target, handler) {
  return revocable(virtual, virtualizeHandler(target, handler));
};

/** @type {import("../type").VirtualObject} */
export const VirtualObject = function (target, handler) {
  return VirtualProxy(
...
/** @type {import("../type").VirtualArray} */
export const VirtualArray = function (target, handler) {
  return VirtualProxy(/** @type {any} */ ([]), target, handler);
};

/** @type {import("../type").VirtualFunction} */
export const VirtualFunction = function (target, handler) {
  return VirtualProxy(
    /** @type {any} */ (
      function () {
        "use-strict";
